...
const Porjects = ({ setSelectedPage }: Props) => {
  return (
    <section
      id="projects"
      className="relative flex items-start justify-center w-full h-screen bg-gradient-space-ltr text-white py-40 md:h-full md:pb-0"
    >
